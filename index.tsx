...
// --- APPLICATION STATE ---
// FIX: Add interfaces for state to improve type safety and resolve downstream errors.
...
const renderLevelScreen = () => {
    ...
    levelGrid.querySelectorAll<HTMLElement>('.unlocked, .completed').forEach(btn => {
...
const renderQuizResult = () => {
    ...
    // FIX: Cast btn to HTMLButtonElement to access dataset and disabled properties.
...
const initMatrix = () => {
    const canvas = dom.matrixCanvas as HTMLCanvasElement;
    if (!canvas) return;
